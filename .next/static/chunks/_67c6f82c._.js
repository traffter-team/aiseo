...
async function callClaudeAPI(prompt) {
    const apiKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.ANTHROPIC_API_KEY;
    if (!apiKey) {
...
"[project]/src/services/new_project_agent.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function fillPrompt(template, userInput) {
    return template.replace('{project_name}', userInput.brand_name).replace('{user_requirements}', "Country: ".concat(userInput.target_country, ", Language: ").concat(userInput.target_language)).replace('{site_type}', userInput.site_type).replace('{industry}', 'Casino');
}
async function runNewProjectAgent(userInput) {
    const prompt = fillPrompt(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$system$2d$prompts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NEW_PROJECT_AGENT_PROMPT"], userInput);
    const reply = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$claude$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["callClaudeAPI"])(prompt);
    return reply;
}
function getNewProjectAgentPrompt(userInput) {
    return fillPrompt(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$system$2d$prompts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NEW_PROJECT_AGENT_PROMPT"], userInput);
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/api/claude/new-project-test/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$new_project_agent$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/new_project_agent.ts [app-client] (ecmascript)");
;
...
function NewProjectAgentTestPage() {
    _s();
    const [userInput, setUserInput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialInput);
    ...
    const handleRunAgent = async ()=>{
        ...
        setError('');
        setReply('');
        const filledPrompt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$new_project_agent$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNewProjectAgentPrompt"])(userInput);
        setPrompt(filledPrompt);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$new_project_agent$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["runNewProjectAgent"])(userInput);
            setReply(result);
        } catch (err) {
...
_s(NewProjectAgentTestPage, "PmpkEpmCJ96eIkfs0boLmkD1PTk=");
_c = NewProjectAgentTestPage;
var _c;
__turbopack_context__.k.register(_c, "NewProjectAgentTestPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_67c6f82c._.js.map