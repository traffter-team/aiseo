...
"[project]/src/lib/claude-api.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function callClaudeAPI(prompt) {
    ...
    const apiKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.CLAUDE_API_KEY;
    if (!apiKey) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            throw new Error("Claude API error: ".concat(response.status, " - ").concat(errorText));
        }
...
"[project]/src/services/system-prompts.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/agent-executor.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$claude$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/claude-api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$system$2d$prompts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/system-prompts.ts [app-client] (ecmascript)");
;
;
const AGENT_CONFIGS = {
    'new-project': {
        ...
        model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$claude$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClaudeModel"].SONNET_3_5,
        maxTokens: 4096,
        temperature: 0.3
    },
    'ui': {
        ...
        model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$claude$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClaudeModel"].SONNET_3,
        maxTokens: 3000,
        temperature: 0.5
    },
    'html-structure': {
    ...
    'composer': {
        ...
        model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$claude$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClaudeModel"].OPUS_3,
        maxTokens: 4096,
        temperature: 0.4
    },
    'tester-validator-reviewer': {
    ...
    'researcher': {
        ...
        model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$claude$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClaudeModel"].HAIKU_3_5,
        maxTokens: 3000,
        temperature: 0.4
    },
    'unicalizator': {
...
async function executeAgent(options) {
    ...
    try {
        ...
        // Validate agent type
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$system$2d$prompts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllAgentTypes"])().includes(agentType)) {
            throw new Error("Invalid agent type: ".concat(agentType));
        }
        // Get agent configuration
        const agentConfig = AGENT_CONFIGS[agentType];
        if (!agentConfig) {
            throw new Error("No configuration found for agent: ".concat(agentType));
        }
        // Get the system prompt
        const systemPrompt = customPrompt || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$system$2d$prompts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAgentPrompt"])(agentType);
        if (!systemPrompt || systemPrompt === 'Agent prompt not found') {
            throw new Error("No system prompt found for agent: ".concat(agentType));
        }
        ...
        // Execute the agent
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$claude$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["callClaudeAPI"])(filledPrompt, claudeOptions);
        ...
        return {
            ...
            metadata: {
                agentType,
                model: claudeOptions.model || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$claude$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClaudeModel"].SONNET_3_5,
        ...
        var _AGENT_CONFIGS_options_agentType, _AGENT_CONFIGS_options_agentType1, _AGENT_CONFIGS_options_agentType2;
        const executionTime = Date.now() - startTime;
        return {
            success: false,
            ...
            metadata: {
                ...
                model: options.modelOverride || ((_AGENT_CONFIGS_options_agentType = AGENT_CONFIGS[options.agentType]) === null || _AGENT_CONFIGS_options_agentType === void 0 ? void 0 : _AGENT_CONFIGS_options_agentType.model) || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$claude$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClaudeModel"].SONNET_3_5,
                maxTokens: options.maxTokensOverride || ((_AGENT_CONFIGS_options_agentType1 = AGENT_CONFIGS[options.agentType]) === null || _AGENT_CONFIGS_options_agentType1 === void 0 ? void 0 : _AGENT_CONFIGS_options_agentType1.maxTokens) || 4096,
                temperature: options.temperatureOverride || ((_AGENT_CONFIGS_options_agentType2 = AGENT_CONFIGS[options.agentType]) === null || _AGENT_CONFIGS_options_agentType2 === void 0 ? void 0 : _AGENT_CONFIGS_options_agentType2.temperature),
                executionTime,
                timestamp: new Date().toISOString()
            }
        };
...
function fillPromptWithUserInput(prompt, userInput) {
    ...
    if (userInput.structure) {
        ...
        const structureInfo = "\nSite Type: ".concat(userInput.site_type || 'Unknown', "\nTotal Pages: ").concat(totalPages || 0, "\nSelected Pages: ").concat((selectedPages === null || selectedPages === void 0 ? void 0 : selectedPages.join(', ')) || 'None', "\nPage Sections:\n").concat((selectedPages === null || selectedPages === void 0 ? void 0 : selectedPages.map((page)=>{
            const sections = (pageSections === null || pageSections === void 0 ? void 0 : pageSections[page]) || [];
            return "- ".concat(page, ": ").concat(sections.join(', '));
        }).join('\n')) || 'No sections defined', "\nTarget Country: ").concat(userInput.target_country || 'Unknown', "\nTarget Language: ").concat(userInput.target_language || 'Unknown', "\nIndustry: ").concat(userInput.industry || 'Casino/Gaming');
        replacements['{structure}'] = structureInfo;
    }
    // Apply all replacements
    Object.entries(replacements).forEach((param)=>{
        let [key, value] = param;
...
function getRecommendedModel(agentType) {
    const agentConfig = AGENT_CONFIGS[agentType];
    return (agentConfig === null || agentConfig === void 0 ? void 0 : agentConfig.model) || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$claude$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClaudeModel"].SONNET_3_5;
}
function getAvailableModels() {
    return Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$claude$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MODEL_CONFIGS"]).map((param)=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$agent$2d$executor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/agent-executor.ts [app-client] (ecmascript)");
;
    ...
    const handleStructureSubmit = async (e)=>{
        ...
        try {
            ...
            if (result) {
                ...
                const agentResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$agent$2d$executor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["executeAgent"])({
...
_s(MainPage, "XIwF9IZvDEEYNPoo9kcPUppPYTA=");
_c = MainPage;
...
//# sourceMappingURL=src_c262799c._.js.map